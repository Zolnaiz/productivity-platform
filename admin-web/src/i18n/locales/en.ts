...
const en = {
  ...
  auditTierSettings: {
    title: 'Audit layers',
    subtitle: 'What each layer is called, who walks it and how often.',
    usingDefaults: 'Using the default layers until this organization sets its own.',
    newLayer: 'New layer',
    addLayer: 'Add a layer',
    removeLayer: 'Remove {{name}}',
    restoreDefaults: 'Back to the defaults',
    anyRole: 'Anybody',
    layerName: 'Name of layer {{tier}}',
    layerRole: 'Who walks layer {{tier}}',
    layerFrequency: 'How often layer {{tier}} is walked',
  },
  holdingArea: {
  ...
  */
  ...
  fiveSStandard: {
    title: 'The standard this organization works to',
    subtitle: 'The cadence, the labelling rules, the criteria and the checklists. Yours to change.',
    cadence: 'Operating cadence',
    cadenceTitle: 'Name of cadence row {{index}}',
    cadenceTiming: 'Timing of cadence row {{index}}',
    cadenceDetail: 'What happens in cadence row {{index}}',
    addCadence: 'Add a row',
    removeCadence: 'Remove {{name}}',
    labelStandards: 'Labelling rules, one per line',
    criteria: 'Assessment criteria',
    criteriaFormat: 'id | category | criterion, one per line',
    checklists: 'Public checklists',
    checklistsFormat: 'code | title, then each item on its own line starting with -',
    save: 'Save the standard',
    saved: 'Saved.',
  ...
  fiveS: {
    toolRoute: 'Route',
    routeName: 'Route',
    routeRegister: 'Walked routes',
    routeTotal: '{{length}} in total',
    routeLongestLeg: 'longest leg {{length}}',
    routeNameOf: 'Name of {{name}}',
    routeRemove: 'Remove {{name}}',
    routeHint: 'Click where the walk starts, then each place it goes. Double-click to finish.',
