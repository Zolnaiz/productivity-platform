    ...
    var HttpExceptionFilter = _classThis = /** @class */ (function () {
        ...
        HttpExceptionFilter_1.prototype.catch = function (exception, host) {
            ...
            if (exception instanceof common_1.HttpException) {
                ...
                var responseData = exception.getResponse();
            ...
            // Log the error
            this.logger.error("HTTP ".concat(status, " - ").concat(message, " - ").concat(request.method, " ").concat(request.url), exception instanceof Error ? exception.stack : '');
            // Send response
