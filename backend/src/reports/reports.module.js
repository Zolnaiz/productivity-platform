...
var response_entity_1 = require("../shared/entities/response.entity");
var users_module_1 = require("../users/users.module");
var organizations_module_1 = require("../organizations/organizations.module");
var ReportsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                typeorm_1.TypeOrmModule.forFeature([report_entity_1.Report, questionnaire_entity_1.Questionnaire, expense_entity_1.Expense, response_entity_1.Response]),
