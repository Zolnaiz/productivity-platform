...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.resetPassword = function (token, password) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.resetPassword(token, password)];
                });
            });
        };
        AuthController_1.prototype.changePassword = function (req, currentPassword, newPassword) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.changePassword(req.user.id, currentPassword, newPassword)];
                });
            });
        };
    ...
    (function () {
        ...
        _login_decorators = [(0, public_decorator_1.Public)(), (0, common_1.UseGuards)(local_auth_guard_1.LocalAuthGuard), (0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        ...
        _changePassword_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('change-password')];
